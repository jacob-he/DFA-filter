package com.imybest.wordsfilter;
...
public class Test {
	public void test(){
		...
		try {
			...
			System.out.println(dfa.searchKeyword(content));
			//				System.out.println();
		} catch (UnsupportedEncodingException e) {
...
//			System.out.println(bts.length);
	...
	public static void main(String[] args) {
		String test = "<b><span><img alnt=\"\" src=\"http://img0.wangjiu.com/product/20120821/4823577051507272\" style=\"width: 430px; height: 293px; \" /></span></b>";
...
//			dfa.addKeyWord("阿斯达");
//			dfa.addKeyWord("测斯达");
//			System.out.println(dfa.searchKeyword("我测试测斯达方法"));
////			System.out.println(dfa.searchKeyword("我1测试方法"));
////			System.out.println(dfa.searchKeyword("我方测试方法"));
//		} catch (UnsupportedEncodingException e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
